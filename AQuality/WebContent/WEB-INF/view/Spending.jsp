...
<%@page import="dto.SpendingDto" %>
<%@page import="java.util.ArrayList" %>
<%ArrayList<SpendingDto> result = (ArrayList<SpendingDto>)request.getAttribute("result");%>
            ...
            <div class="main_table">
                <table border="1" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <%ArrayList<SpendingDto> data = AQualityDAO.searchAllSpending();%>
                        <!-- データベースに入っているデータ数を格納-->
